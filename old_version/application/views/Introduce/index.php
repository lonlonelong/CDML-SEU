...
<title>实验室简介-数据库与复杂数据管理实验室</title>
		...
		<div class="row">
			...
			<div class="col-md-2" id="nav">
				<ul class="nav nav-list">
					<li><a href="welcome"><span class="glyphicon glyphicon-home"
							aria-hidden="true"></span><span class="text">首页</span> </a></li>
					<li class="selected"><a href="introduce"><span
							class="glyphicon glyphicon-th-list" aria-hidden="true"></span><span
							class="text">实验室</span> </a></li>
			...
			<div class="col-md-10 con_right">
				...
				<div class="pagetitle">实验室简介</div>

				<div class="sub">
					<div class="content_p"
						style="height: 250px; padding-top: 10px;">
						<p>
							数据库与复杂数据管理实验室隶属于<a href="http://www.seu.edu.cn" target="_blank">东南大学</a>和<a
								href="http://cse.seu.edu.cn" target="_blank">东南大学计算机科学与工程学院</a>。实验室位于东南大学九龙湖校区计算机楼402室和501室，负责人是<a
								href="http://cse.seu.edu.cn/PersonalPage/lujianhua/index.htm"
								target="_blank">吕建华</a>和<a
								href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
								target="_blank">张柏礼</a>副教授。
						</p>
						<p>实验室的主要研究方向为不确定图，无线传感器网络和健康数据管理。目前在研项目有:测试测试</p>
						<p>这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。这是一个演示引导主体副本用法的实例。</p>
					</div>

				</div>

				<div class="sub">
					<div class="subtitle">组织结构</div>
