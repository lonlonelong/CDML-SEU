...
<title>新闻中心-数据库与复杂数据管理实验室</title>
		...
		<div class="row">
			...
			<div class="col-md-2" id="nav">
				<ul class="nav nav-list">
					...
					<li class="selected"><a href="news"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span><span class="text">新闻中心</span></a></li>
			...
			<div class="col-md-10 con_right">
				...
				<div class="row">
					<div class="col-md-12">
						[<a href="#teacher">2015</a>] {<a
							href="<?php echo base_url().'news/post_news';?>">2014</a> | <a
							href="<?php echo base_url().'news/post_news';?>">2013</a> | <a href="<?php echo base_url().'news/post_news';?>">2012</a>}
					</div>
				</div>		
				...
				<div class="sub">
					...
					<div>
                    	<div class="news_list"><span class="news_date">2015-10-31</span> <span class="news_title"><a href="">数据库与管理实验室网站上线数据库与复杂数据管理实验室网站上线</a></span></div>
                        ...
                        <div class="news_list"><span class="news_date">2015-10-31</span> <span class="news_title"><a href="">数据管理实验室网站上线数据库与复杂数据管理实验室网站上线</a></span></div>
                        <div class="news_list"><span class="news_date">2015-10-31</span> <span class="news_title"><a href="">数管理实验室网站上线数据库与复杂数据管理实验室网站上线</a></span></div>
                        <div class="news_list"><span class="news_date">2015-10-31</span> <span class="news_title"><a href="">数据库与理实验室网站上线数据库与复杂数据管理实验室网站上线</a></span></div>
                    </div>
                    
                    <div style="padding-bottom:20px; padding-top:5px;">{<a href="news/post_news">以往新闻</a>}</div>
