		...
		<div class="row">
			...
			<div class="col-md-2" id="nav">
				<ul class="nav nav-list">
					...
					<li class="selected"><a href="links"><span
							class="glyphicon glyphicon-link" aria-hidden="true"></span><span
							class="text">链接</span> </a></li>
				</ul>
			</div>
			...
			<div class="col-md-10 con_right">
				...
				<div class="row">
					<div class="col-md-12">
						[<a href="#teacher">Academic Publications</a>] [<a href="#master">Online
							Resources</a>]
					</div>
				</div>
				...
				<div class="sub" style="padding-bottom:20px;">
					<div class="subtitle">Online Resources</div>
                    <div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">谷歌学术</a>
					</div>
                    <div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">百度学术</a>
					</div>
				</div>
                
                <div class="sub">
					<div class="subtitle">Academic Publications</div>
					<div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">计算机学报</a>
					</div>
					<div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">软件学报</a>
					</div>
					<div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">东南大学学报</a>
					</div>
					<div class="col-md-12 links">
						• <a
							href="http://cse.seu.edu.cn/PersonalPage/bailey_zhang/index.htm"
							target="_blank">IEEE</a>
					</div>
				</div>
