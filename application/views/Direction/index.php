...
<title>研究方向-数据库与复杂数据管理实验室</title>
		...
		<div class="row">
			...
			<div class="col-md-2" id="nav">
				<ul class="nav nav-list">
					...
					<li class="selected"><a href="Direction"><span
							class="glyphicon glyphicon-flag" aria-hidden="true"></span><span
							class="text">研究方向</span> </a></li>
			...
			<div class="col-md-10 con_right">
				<div class="pagetitle">研究方向</div>
				<div class="row">
					<div class="col-md-12">
						[<a href="#teacher">不确定图</a>] [<a href="#master">无线传感器网络</a>] [<a
							href="<?php echo base_url().'people/previous_people';?>">健康数据管理</a>]
					</div>
				</div>

				<div class="sub">
					<div class="subtitle">不确定图</div>
					<div>
					...
					<div class="sub">
						<div class="subtitle">无线传感器网络</div>
